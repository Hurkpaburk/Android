...
public class WebsiteListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<WorkContent.WorkItem>(
                getActivity(),
                android.R.layout.simple_list_item_activated_1,
                android.R.id.text1,
                WorkContent.arrayListWork));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(WorkContent.arrayListWork.get(position).getTitle());
    }
